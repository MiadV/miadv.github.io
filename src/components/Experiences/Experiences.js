      ...
      <Card className="experienceCard card-box p-4">
        ...
        <Grid container spacing={3} className="mb-2">
          ...
          <Grid item xs={12} md={9}>
            ...
            <div className="my-3">
              Designing and developing an online membership system based on
              (React-js, PHP backend, android app using react-native) Developed
              an expense management system based on MS Access and MY-SQL for
              accounting department. Designing and maintaining several static
              and e-commerce websites(customized Woo-commerce) including
              company’s online profile. Managing Brands Social Media (Facebook,
              Instagram) Running social media marketing campaigns (SMM)
            </div>
          </Grid>
        </Grid>
